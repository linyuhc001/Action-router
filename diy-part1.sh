...
git clone --branch v1.79 https://github.com/tty228/luci-app-serverchan package/luci-app-serverchan
...
# 自定义定制选项
sed -i 's#192.168.1.1#192.168.3.1#g' package/base-files/files/bin/config_generate #定制默认IP
...
# CONFIG_PACKAGE_https-dns-proxyis not set
